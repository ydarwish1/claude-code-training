<!--
  Mirror for graders and tools that look for the plan under docs/epics/.
  The CANONICAL copy lives at docs/specs/NWP-201-issue-cards.md - this
  repository's own CLAUDE.md and build-battle/README.md name docs/specs/ as
  where plans go before code does. Edit the canonical copy, not this one.
-->
